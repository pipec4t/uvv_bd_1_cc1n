...
ALTER TABLE cargos COMMENT 'Tabela que armazena o número, cargo e salários da empresa.';

ALTER TABLE cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'É a Primary Key que liga cada cargo a um número. ';

ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'É o nome dos cargos disponíveis.';

ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'É o menor valor aceitável para determinado cargo.';

ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'É o maior valor aceitável para determinado cargo.';
...
ALTER TABLE regioes COMMENT 'Tabela onde é armazenado o número e o nome de cada região.';

ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Primary Key que liga cada região a um número. ';

ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Alternate Key que dá o nome de cada região. ';
...
ALTER TABLE paises COMMENT 'Tabela onde é armazenado informações de cada país.';

ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Primary Key que liga cada país a um número. ';

ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Alternate Key que dá o nome de cada país. ';

ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Foreign Key que Identifica as regiões dos países.';
...
ALTER TABLE localizacoes COMMENT 'Tabela onde é armazenado as localizações da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Primary Key que Liga cada localização a um número. ';

ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'É o endereço de cada local da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'É o CEP de cada local da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'É a cidade de cada local da empresa.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado de cada local da empresa abreviado ou por extenso.';
...
ALTER TABLE departamentos COMMENT 'Tabela onde é armazenado informações dos departamentos. ';

ALTER TABLE departamentos MODIFY COLUMN id_departamento INTEGER COMMENT 'É a Primary Key Liga cada departamento a um número. ';

ALTER TABLE departamentos MODIFY COLUMN nome VARCHAR(50) COMMENT 'É o nome de cada departamento.';

ALTER TABLE departamentos MODIFY COLUMN id_localizacao INTEGER COMMENT 'FK que identifica a localização dos departamentos.  ';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'Foreign Key que identifica o gerente de cada departamento. ';
...
ALTER TABLE empregados COMMENT 'Tabela onde é armazenado os dados básicos dos empregados.';

ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'Primary Key que liga cada empregado a um número. ';

ALTER TABLE empregados MODIFY COLUMN nome VARCHAR(75) COMMENT 'É o nome completo do empregado.';

ALTER TABLE empregados MODIFY COLUMN email VARCHAR(35) COMMENT 'AK que indica a parte antes do @ do email dos empregados.';

ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'É o número de telefone de cada empregado.';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'É a data em que o empregado foi contratado para o emprego.';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Foreign Key identifica os cargos atuais dos empregados. ';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'É o valor mensal que o empregado recebe.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'É a porcentagem de comissão que um empregado receberá.';

ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'FK que identifica o departamento atual dos empregados. ';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'FK identificando o empregado supervisor de outro empregado. ';
...
ALTER TABLE historico_cargos COMMENT 'Tabela que armazena o histórico dos cargos funcionários.';

ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'PK que também é uma FK que liga cada empregado a um número.';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Uma das PK dizendo a data inicial do empregado em um cargo.';

ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Indica a data final de um funcionário em um cargo. ';

ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Foreign Key que identifica o cargo antigo do empregado. ';
